...
object Lab17_NLPPipeline {
  ...
  // Write metrics to the same directory as this source file
  val log_path = "lab17_metrics.log" // Save log file near Main.scala
  ...
  // Write data results to the same directory as this source file
  val result_path = "lab17_pipeline_output.txt" // Save output file near Main.scala
